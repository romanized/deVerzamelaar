...
--
-- Host: localhost
-- Gegenereerd op: 10 nov 2023 om 09:37
...
(9, 'test2023', 'test230@gmail.com', 'testing\r\n', '2023-11-10 08:32:12');
...
(8, 2, 'Test123', '090006@glr.nl', '123123123', 'Heer bokkelweg 255', '2023-10-27 06:58:50'),
(9, 2, 'nebi', 'nebi@gmail.com', '01230123', 'jansteenlaan 123', '2023-11-10 08:32:25');
...
(1, 'nebi', '$2y$10$if4oBkPdmaVag0UNeRDmVO9.Af.HlL/USaAmSTRpMSSL2cua1q1DO', 1);

-- --------------------------------------------------------

--
-- Tabelstructuur voor tabel `verzameling`
--
...
--
-- Gegevens worden geëxporteerd voor tabel `verzameling`
--
...
--
-- Indexen voor tabel `verzameling`
--
...
--
-- AUTO_INCREMENT voor een tabel `verzameling`
--
ALTER TABLE `verzameling`
